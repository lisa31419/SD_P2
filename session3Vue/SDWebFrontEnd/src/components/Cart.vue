              ...
              <tr>
                ...
                <td>9
                  <div class="btn-group" role="group">
                    <button class="btn btn-danger btn-lg mr-1" type="button" @click="returnTickets()"> -</button>
                    <button class="btn btn-success btn-lg " type="button" @click="buyTickets()"> +</button>
                  </div>
                </td>
                <td>{{ show.price }}</td>
                <td>9</td>
                <td>
                  <div class="btn-group" role="group">
                    <button class="btn btn-danger btn-md" type="button">Delete Ticket</button>
                  </div>
                </td>
              </tr>
            </div>
