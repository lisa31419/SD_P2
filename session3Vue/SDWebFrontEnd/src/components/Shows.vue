...
export default {
  ...
  methods: {
    ...
    deleteEvent (show) {
      const path = `https://a3-ticketmonster.herokuapp.com/show/${show}`
      axios.delete(path, {
    ...
    getMoneyFromUser () {
      const path = `https://a3-ticketmonster.herokuapp.com/account/${this.username}`
      axios.get(path)
        .then((res) => {
    ...
    addPurchase (parameters) {
      const path = `https://a3-ticketmonster.herokuapp.com/orders/${this.username}`
    ...
    getShows () {
      const path = 'https://a3-ticketmonster.herokuapp.com/shows'
      axios.get(path)
        .then((res) => {
    ...
    getArtistsInShows () {
      for (let i = 0; i < this.showsLength; i++) {
        const path = `https://a3-ticketmonster.herokuapp.com/show/${this.shows[i].id}/artists`
        axios.get(path)
          .then((res) => {
    ...
    getPlacesInShows () {
      for (let i = 0; i < this.showsLength; i++) {
        ...
        const path = `https://a3-ticketmonster.herokuapp.com/place/${IDplace}`
        axios.get(path)
          .then((res) => {
